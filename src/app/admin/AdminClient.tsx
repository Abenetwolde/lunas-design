...
export default function AdminClient({
  ...
  const handleSaveProduct = async (e: React.FormEvent, isDraft = false) => {
    ...
    const prodData: Partial<Product> = {
      ...
      image: pImage || (pGalleryImages.length > 0 ? pGalleryImages[0] : ''),
      secondaryImage: (pSecondaryImage && pSecondaryImage !== pImage) ? pSecondaryImage : undefined,
      images: Array.from(new Set([pImage, pSecondaryImage, ...pGalleryImages].filter(Boolean) as string[])),
